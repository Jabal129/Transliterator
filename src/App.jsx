      ...
      <main className="flex-grow-1 d-flex align-items-start justify-content-center py-5 px-3">
        <div className="w-100" style={{ maxWidth: 680 }}>
          ...
          <div className="text-center mb-5">
            ...
            >
              حوّل النصوص الإنجليزية والإسبانية والصينية واليابانية والكورية والفيتنامية والروسية
          ...
          <div className="mt-4 text-center">
            ...
            >
              اللغات المدعومة:&nbsp;
              {['الإنجليزية', 'الإسبانية', 'الصينية', 'اليابانية', 'الكورية', 'الفيتنامية', 'الروسية'].map((l, i, arr) => (
                <span key={l}>
